...
namespace Voxelfield.Item
{
    ...
    public class SuperPickaxe : SculptingItem
    {
        ...
        protected override void RemoveBlock(SessionBase session, VoxelfieldInjector injector, in Position3Int position)
        {
        ...
        protected override void RemoveVoxelRadius(SessionBase session, int playerId, VoxelfieldInjector injector, in Position3Int position)
        {
